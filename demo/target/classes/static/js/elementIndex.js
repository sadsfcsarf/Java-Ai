  ...
  return function (e) {
    ...
    var L = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
      ...
      el: {
        ...
        cascader: {noMatch: "无匹配数据", loading: "加载中", placeholder: "请选择", noData: "No data at present"},
        pagination: {goto: "Go page", pagesize: "item", total: "Total {total} items", pageClassifier: ""},
        ...
        tree: {emptyText: "No data at present"},
        transfer: {
          noMatch: "无匹配数据",
          noData: "无数据",
          titles: ["列表 1", "列表 2"],
    ...
    var Ih = function () {
      ...
      return i("transition", {attrs: {name: "viewer-fade"}}, [i("div", {
        ...
        i("div", {staticClass: ""}, [i("div", {staticClass: "el-image-viewer__actions__inner"}, [i("i", {
